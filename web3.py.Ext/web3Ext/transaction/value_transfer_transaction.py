...
class ValueTransferTransaction(_TypedTransactionImplementation):
    ...
    unsigned_transaction_fields_with_type = (
        ("type", big_endian_int),
    ...
    _unsigned_transaction_serializer_with_type = type(
        "_unsigned_transaction_serializer_with_type",
        (HashableRLP,),
        {
            "fields": unsigned_transaction_fields_with_type,
        },
    )
    ...
    def hash(self) -> bytes:
        ...
        transaction_without_signature_fields = dissoc(self.dictionary, "v", "r", "s","chainId")
        rlp_serializer = self.__class__._unsigned_transaction_serializer_with_type
        hash = pipe(
