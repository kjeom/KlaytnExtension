...
@staticmethod
@wraps(to_wei)
def to_peb(number: Union[int, float, str, decimal.Decimal], unit: str) -> Ston:
    return cast(Ston, to_wei(number, unit))

@staticmethod
@wraps(from_wei)
def from_peb(number: int, unit: str) -> Union[int, decimal.Decimal]:
