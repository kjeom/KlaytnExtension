...
from klaytn_account.account_key import AccountKey
...
class AccountUpdateTransaction(_TypedTransactionImplementation):
    ...
    def payload(self) -> bytes:
        ...
        vrs = {"v":transaction_with_encoded_key["v"],"r":transaction_with_encoded_key["r"],"s":transaction_with_encoded_key["s"]}
    ...
    """
    TODO update - because of signature list in klaytn transaction
    """
