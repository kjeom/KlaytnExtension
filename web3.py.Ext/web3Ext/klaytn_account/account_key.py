...
class AccountKey(object):
    ...
    def serialize(cls, obj: Any) -> bytes:
        ...
        if obj["type"] == AccountKeyLegacy.key_type:
...
class AccountKeyLegacy(object):
    ...
    def serialize(cls, obj) -> bytes:
        ...
        return rlp.encode(obj['type']) + rlp.encode(obj['key'])
...
class AccountKeyPublic(object):
    ...
    def deserialize(cls, serial) -> Dict[str, Any]:
        ...
        return {
            'type': cls.key_type,
            'key': '0x' + bytes_to_hex_str(serial[1:])
        }
    ...
    def deserialize(cls, serial) -> Dict[str, Any]:
        ...
        return {
            ...
            'keys': {
                ...
                'rolwAccountUpdateKey' : AccountKey.deserialize(keys[1]),
